    ...
    public abstract partial class BaseMetricsFactory
    {
        private sealed class TypeConstructor
        {
            ...
            static TypeConstructor()
            {
                ...
                System.Reflection.Emit.ModuleBuilder = assemblyBuilder.DefineDynamicModule("JaegerAutoGeneratedModule");
            }

            public TypeConstructor()
            {
                var interfaceType = typeof(IMetrics);
                var typeBuilder = System.Reflection.Emit.ModuleBuilder.DefineType("GenericMetrics", TypeAttributes.Public | TypeAttributes.Sealed);
